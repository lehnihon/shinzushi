		...
		<div class="container">
			...
			<div class="row justify-content-center wow fadeIn">
				<div class="col-md-auto">
					<a href="<?php echo home_url( 'o-shinzushi' ); ?>" title="O shinzushi">O Shinzushi</a>
				</div>
				<div class="col-md-auto">
					<a href="<?php echo home_url( 'chef' ); ?>" title="Chef">Chef</a>
				</div>
				<div class="col-md-auto">
					<a href="<?php echo home_url( 'menu' ); ?>" title="Menu">Menu</a>
				</div>
				<div class="col-md-auto">
					<a href="<?php echo home_url( 'fotos' ); ?>" title="foto"s>Fotos</a>
				</div>
				<div class="col-md-auto">
			...
			<div class="row wow fadeIn">
				<div class="col-md-12">
				<span>&copy; <?php echo date('Y') ?> Shinzushi Restaurante - Todos os direitos reservados</span>
				</div>
			</div>
		</div>
	</footer><!-- #footer -->
